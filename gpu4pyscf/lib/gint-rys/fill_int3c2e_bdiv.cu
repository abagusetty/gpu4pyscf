                         ...
                         )
{
    ...
    int &nfi = *sycl::ext::oneapi::group_local_memory_for_overwrite<int>(thread_block);
    int &nfj = *sycl::ext::oneapi::group_local_memory_for_overwrite<int>(thread_block);
    int &nfk = *sycl::ext::oneapi::group_local_memory_for_overwrite<int>(thread_block);
    int &nfij = *sycl::ext::oneapi::group_local_memory_for_overwrite<int>(thread_block);
    ...
    int &stride_j = *sycl::ext::oneapi::group_local_memory_for_overwrite<int>(thread_block);
    ...
    if (int3c2e_bdiv_unrolled(shared_memory, out, envs, bounds)) {
        return;
    }
