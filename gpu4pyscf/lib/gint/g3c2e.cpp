template <int NROOTS, int GSIZE_INT3C> __attribute__((always_inline))
void GINTfill_int3c2e_kernel(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
