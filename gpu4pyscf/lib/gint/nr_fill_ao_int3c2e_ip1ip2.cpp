...
static int GINTfill_int3c2e_ip1ip2_tasks(ERITensor *eri, BasisProdOffsets *offsets, GINTEnvVars *envs, sycl::queue& stream)
{
...
extern "C" {
int GINTfill_int3c2e_ip1ip2(sycl::queue& stream, BasisProdCache *bpcache, double *eri, int nao,
