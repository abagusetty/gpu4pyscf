...
void GINTfill_int3c2e_ipvip1_kernel(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    ...
    double* __restrict__ exp_ket = c_bpcache.get().a2;
    int ij, kl;
