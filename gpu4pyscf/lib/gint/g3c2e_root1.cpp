...
static void GINTfill_int3c2e_kernel0000(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
...
__attribute__((always_inline))
static void GINTfill_int3c2e_kernel0010(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTfill_int3c2e_kernel1000(GINTEnvVars envs, ERITensor eri, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
