...
#define LAUNCH_RYS_JK(KERNEL) { \
    ...
    sycl_get_queue()->submit([&](sycl::handler &cgh) { \
        ...
        cgh.parallel_for<class KERNEL##_sycl>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { \
            KERNEL(dev_envs, dev_jk, dev_bounds, q_cond_ij, q_cond_kl, dm_penalty, s_cond_ij, s_cond_kl, diffuse_exps, pool, head, item, GPU4PYSCF_IMPL_SYCL_GET_MULTI_PTR(local_acc)); \
        }); \
    }); \
}
#else
#define LAUNCH_RYS_JK(KERNEL) { \
    ...
    KERNEL<<<workers, threads, buflen*sizeof(double)>>>(*envs, *jk, *bounds, q_cond_ij, q_cond_kl, dm_penalty, s_cond_ij, s_cond_kl, diffuse_exps, pool, head); \
}
#endif
    switch (ijkl) {
    case 0: LAUNCH_RYS_JK(rys_k_0000); break;
    case 125: LAUNCH_RYS_JK(rys_k_1000); break;
    case 130: LAUNCH_RYS_JK(rys_k_1010); break;
    case 131: LAUNCH_RYS_JK(rys_k_1011); break;
    case 150: LAUNCH_RYS_JK(rys_k_1100); break;
    case 155: LAUNCH_RYS_JK(rys_k_1110); break;
    case 156: LAUNCH_RYS_JK(rys_k_1111); break;
    case 250: LAUNCH_RYS_JK(rys_k_2000); break;
    case 255: LAUNCH_RYS_JK(rys_k_2010); break;
    case 256: LAUNCH_RYS_JK(rys_k_2011); break;
    case 260: LAUNCH_RYS_JK(rys_k_2020); break;
    case 261: buflen = 4736 + iprim*jprim; LAUNCH_RYS_JK(rys_jk_2021); break;
    case 275: LAUNCH_RYS_JK(rys_k_2100); break;
    case 280: LAUNCH_RYS_JK(rys_k_2110); break;
    case 281: buflen = 2944 + iprim*jprim; LAUNCH_RYS_JK(rys_jk_2111); break;
    case 285: buflen = 4736 + iprim*jprim; LAUNCH_RYS_JK(rys_jk_2120); break;
    case 300: LAUNCH_RYS_JK(rys_k_2200); break;
    case 305: buflen = 4736 + iprim*jprim; LAUNCH_RYS_JK(rys_jk_2210); break;
    case 375: LAUNCH_RYS_JK(rys_k_3000); break;
    case 380: LAUNCH_RYS_JK(rys_k_3010); break;
    case 381: buflen = 4352 + iprim*jprim; LAUNCH_RYS_JK(rys_jk_3011); break;
    case 385: LAUNCH_RYS_JK(rys_k_3020); break;
    case 400: LAUNCH_RYS_JK(rys_k_3100); break;
    case 405: buflen = 4352 + iprim*jprim; LAUNCH_RYS_JK(rys_jk_3110); break;
    case 425: LAUNCH_RYS_JK(rys_k_3200); break;
    default: return 0;
    }
#undef LAUNCH_RYS_JK
    return 1;
