...
static void GINTint2e_jk_kernel1010(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    ...
    for (i_dm = 0; i_dm < n_dm; ++i_dm) {
        if (vj != NULL) {
            ...
            block_reduce_x<THREADSX, THREADSY>(gout0*d_0 + gout1*d_1 + gout2*d_2, vj+(k0+0)+nao*(l0+0), tx, ty, item);
            block_reduce_x<THREADSX, THREADSY>(gout3*d_0 + gout4*d_1 + gout5*d_2, vj+(k0+1)+nao*(l0+0), tx, ty, item);
            block_reduce_x<THREADSX, THREADSY>(gout6*d_0 + gout7*d_1 + gout8*d_2, vj+(k0+2)+nao*(l0+0), tx, ty, item);
            ...
            block_reduce_y<THREADSX, THREADSY>(gout0*d_0 + gout3*d_1 + gout6*d_2, vj+(i0+0)+nao*(j0+0), tx, ty, item);
            block_reduce_y<THREADSX, THREADSY>(gout1*d_0 + gout4*d_1 + gout7*d_2, vj+(i0+1)+nao*(j0+0), tx, ty, item);
            block_reduce_y<THREADSX, THREADSY>(gout2*d_0 + gout5*d_1 + gout8*d_2, vj+(i0+2)+nao*(j0+0), tx, ty, item);
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel1011(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel1100(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel1110(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel2000(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel2010(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel2100(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
...
__attribute__((always_inline))
static void GINTint2e_jk_kernel3000(GINTEnvVars envs, JKMatrix jk, BasisProdOffsets offsets, sycl::nd_item<2>& item)
{
    int ntasks_ij = offsets.ntasks_ij;
    int ntasks_kl = offsets.ntasks_kl;
    int task_ij = static_cast<int>( item.get_global_id(1) );
