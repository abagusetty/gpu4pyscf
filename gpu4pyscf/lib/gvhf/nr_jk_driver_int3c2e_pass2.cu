...
static int GINTrun_tasks_int3c2e_pass2_j(JKMatrix *jk, BasisProdOffsets *offsets, GINTEnvVars *envs, cudaStream_t stream)
{
    ...
    switch (envs->nrys_roots) {
        case 1:
            ...
            switch (type_ijkl) {
                case 0b0000: stream.parallel_for<class GINTint3c2e_pass2_j_kernel_0000>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel0000(dev_envs, dev_jk, dev_offsets); }); break;
                case 0b0010: stream.parallel_for<class GINTint3c2e_pass2_j_kernel_0010>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel0010(dev_envs, dev_jk, dev_offsets); }); break;
                case 0b1000: stream.parallel_for<class GINTint3c2e_pass2_j_kernel_1000>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel1000(dev_envs, dev_jk, dev_offsets); }); break;
                default: fprintf(stderr, "rys root 1 type_ijkl %d\n", type_ijkl);
                return 1;
                }
            break;
        case 2: stream.parallel_for<class GINTint3c2e_pass2_j_kernel2>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<2, GSIZE2_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 3: stream.parallel_for<class GINTint3c2e_pass2_j_kernel3>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<3, GSIZE3_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 4: stream.parallel_for<class GINTint3c2e_pass2_j_kernel4>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<4, GSIZE4_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 5: stream.parallel_for<class GINTint3c2e_pass2_j_kernel5>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<5, GSIZE5_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 6: stream.parallel_for<class GINTint3c2e_pass2_j_kernel6>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<6, GSIZE6_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 7: stream.parallel_for<class GINTint3c2e_pass2_j_kernel7>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<7, GSIZE7_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 8: stream.parallel_for<class GINTint3c2e_pass2_j_kernel8>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<8, GSIZE8_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
        case 9: stream.parallel_for<class GINTint3c2e_pass2_j_kernel9>(sycl::nd_range<2>(blocks * threads, threads), [=](auto item) { GINTint3c2e_pass2_j_kernel<9, GSIZE9_INT3C> (dev_envs, dev_jk, dev_offsets); }); break;
